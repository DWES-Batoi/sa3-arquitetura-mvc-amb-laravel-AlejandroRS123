...
@section('content')
<h1 class="text-3xl font-bold text-blue-800 mb-6">Guia de jugadoras</h1>
...
<p class="mb-4">
    <a href="{{ route('jugadoras.create') }}" class="bg-blue-600 text-white px-3 py-2 rounded">Nova jugadora</a>
</p>
    ...
    <tbody>
        ...
        <tr class="hover:bg-gray-100">
            <td class="border border-gray-300 p-2">
                <a href="{{ route('jugadoras.show', $key) }}" class="text-blue-700 hover:underline">{{ $jugadora['nom'] }}</a>
            </td>
